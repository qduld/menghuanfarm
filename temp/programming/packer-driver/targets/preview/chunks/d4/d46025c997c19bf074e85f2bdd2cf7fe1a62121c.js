        ...
        start() {
          if (this.isChild) {
            this.nodes.children.forEach(node => {
              var action = tween().target(node).to(this.sleep, {
            ...
            var action = tween().target(this.node).to(this.sleep, {
              scale: new Vec3(this.scaleMax, this.scaleMax, 0),
...
//# sourceMappingURL=d46025c997c19bf074e85f2bdd2cf7fe1a62121c.js.map