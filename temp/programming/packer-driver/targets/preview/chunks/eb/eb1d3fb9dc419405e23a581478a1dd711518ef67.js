  ...
  return {
    ...
    execute: function () {
      ...
      _export("main", main = (_dec = ccclass('main'), _dec(_class = (_class2 = class main extends Component {
        ...
        clickLoginBtn() {
          var btn = find("Canvas/btnClick");
          btn.getComponent(AudioSource).play();
        }

        clickBtn() {
          var btn = find("MainCanvas/btnClick");
          btn.getComponent(AudioSource).play();
        }
        ...
        static addSalePack(type) {
          var sale_item = new Node(); //成熟果实仅仅可以售卖 只入包一次
        ...
        addPaiHang() {
          ...
          (_crd && paiHang === void 0 ? (_reportPossibleCrUseOfpaiHang({
            ...
            var clone_item = instantiate(paiHangBox.getChildByName("items"));
            clone_item.layer = Layers.Enum.UI_2D;
            clone_item.setParent(paiHangBox);
            clone_item.setPosition(0, 0 - clone_item.position.y - 240 * index, 0);
            var name = clone_item.getChildByName("box").getChildByName("txtBox").getChildByName("name");
            ...
            resources.load(item.top === 1 ? "1/spriteFrame" : item.top === 2 ? "2/spriteFrame" : "3/spriteFrame", SpriteFrame, (err, spriteFrame) => {
              var top = clone_item.getChildByName("box").getChildByName("txtBox").getChildByName("top");
            ...
            resources.load(item.userAvata, SpriteFrame, (err, spriteFrame) => {
              var sp = clone_item.getChildByName("box").getChildByName("txtBox").getChildByName("pro");
        ...
        closeDialog(event) {
          var type = event.currentTarget.parent.name + "_" + event.currentTarget.name;
        ...
        buyPlant(event) {
          //必须把种子背包的种子用完才可以购买种子
          var mySaleBoxItems = find("MainCanvas/popBox/mypack/items");
          ...
          var currentJinbi = parseInt(jinbi.getComponent(Label).string);
          var price = 0;
          ...
          if (event.currentTarget.parent.parent.name === "fanqiezz") {
            ...
            if (currentJinbi - price <= 0) {
              ...
              var arrIndex = myPackBox.getChildByName("items").children.findIndex(item => {
          ...
          if (event.currentTarget.parent.parent.name === "pingguozz") {
            ...
            if (currentJinbi - price <= 0) {
              ...
              var _arrIndex = myPackBox.getChildByName("items").children.findIndex(item => {
          ...
          if (event.currentTarget.parent.parent.name === "qiezizz") {
            ...
            if (currentJinbi - price <= 0) {
              ...
              var _arrIndex2 = myPackBox.getChildByName("items").children.findIndex(item => {
          ...
          if (event.currentTarget.parent.parent.name === "huluobozz") {
            ...
            if (currentJinbi - price <= 0) {
              ...
              var _arrIndex3 = myPackBox.getChildByName("items").children.findIndex(item => {
        ...
        boZhong(event) {
          ...
          var arrIndex = plants.children.findIndex(item => {
          ...
          var Timer = find("MainCanvas/Timer"); //播种完成需要重置生长时间
        ...
        adCalcTime(event, customEventData) {
          var currentMoney = parseInt(jinbi.getComponent(Label).string);
...
//# sourceMappingURL=eb1d3fb9dc419405e23a581478a1dd711518ef67.js.map